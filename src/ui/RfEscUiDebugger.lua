...
local function _getSoilModDirectory()
    ...
    if (SeasonalCropStressModName or g_currentModName) == SOIL_MOD_NAME and (SeasonalCropStressModDirectory or g_currentModDirectory) ~= nil then
        return (SeasonalCropStressModDirectory or g_currentModDirectory)
    end
...
local function _getXmlPath()
    ...
    if (SeasonalCropStressModDirectory or g_currentModDirectory) ~= nil then
        return (SeasonalCropStressModDirectory or g_currentModDirectory) .. "xml/gui/" .. CLASS_NAME .. ".xml"
    end
    return nil
end
...
local function _getProfilesXml()
    ...
    return _profilesCandidate((SeasonalCropStressModDirectory or g_currentModDirectory))
end
...
function RfEscUiDebugger.install()
    ...
    local soilDir = _getSoilModDirectory()
    local myDir = (SeasonalCropStressModDirectory or g_currentModDirectory)
    ...
    local owner = ((SeasonalCropStressModName or g_currentModName) ~= nil and (SeasonalCropStressModName or g_currentModName)) or "unknown"
